...
{
    {
        kit::local_shared_ptr< int > pi = kit::make_local_shared< int >();
    ...
    {
        kit::local_shared_ptr< int > pi = kit::make_local_shared< int >( 5 );
    ...
    {
        kit::local_shared_ptr< X > pi = kit::make_local_shared< X >();
    ...
    {
        kit::local_shared_ptr< X > pi = kit::make_local_shared< X >( 1 );
        kit::local_weak_ptr<X> wp( pi );
    ...
    {
        kit::local_shared_ptr< X > pi = kit::make_local_shared< X >( 1, 2 );
        kit::local_weak_ptr<X> wp( pi );
    ...
    {
        kit::local_shared_ptr< X > pi = kit::make_local_shared< X >( 1, 2, 3 );
        kit::local_weak_ptr<X> wp( pi );
    ...
    {
        kit::local_shared_ptr< X > pi = kit::make_local_shared< X >( 1, 2, 3, 4 );
        kit::local_weak_ptr<X> wp( pi );
    ...
    {
        kit::local_shared_ptr< X > pi = kit::make_local_shared< X >( 1, 2, 3, 4, 5 );
        kit::local_weak_ptr<X> wp( pi );
    ...
    {
        kit::local_shared_ptr< X > pi = kit::make_local_shared< X >( 1, 2, 3, 4, 5, 6 );
        kit::local_weak_ptr<X> wp( pi );
    ...
    {
        kit::local_shared_ptr< X > pi = kit::make_local_shared< X >( 1, 2, 3, 4, 5, 6, 7 );
        kit::local_weak_ptr<X> wp( pi );
    ...
    {
        kit::local_shared_ptr< X > pi = kit::make_local_shared< X >( 1, 2, 3, 4, 5, 6, 7, 8 );
        kit::local_weak_ptr<X> wp( pi );
    ...
    {
        kit::local_shared_ptr< X > pi = kit::make_local_shared< X >( 1, 2, 3, 4, 5, 6, 7, 8, 9 );
        kit::local_weak_ptr<X> wp( pi );
